...
|---|---|---|
| Infrastructure | Host-level monitoring for Core / WEB / Mobile and satellite systems | Basic plus deeper analysis when approved |
...
| Vero Dashboard | Shows overall system, Core / WEB / Mobile detail, satellite systems, and KPI/SLA |
